...
namespace MyBackedApi.Migrations
{
    ...
    [Migration("20250520120912_AddComponentEmbeddingsToQuestion")]
    partial class AddComponentEmbeddingsToQuestion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBackedApi.Models.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyBackedApi.Models.StudentDetails", b =>
                {
                    b.HasOne("MyBackedApi.Models.Group", "Group")
                        .WithMany()
